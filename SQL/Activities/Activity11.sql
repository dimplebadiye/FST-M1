...
SELECT customer_name AS "Customer Name", city, name AS "Salesman", commission FROM customers a  
INNER JOIN salesman b ON a.salesman_id = b.salesman_id;

SELECT customer_name AS "Customer Name", city, salesman_name AS "Salesman", commission FROM customers a  
INNER JOIN salesman b ON a.salesman_id = b.salesman_id;

SELECT customer_name, city, grade, salesman_name AS "Salesman", salesman_city FROM customers a  
LEFT OUTER JOIN salesman b ON a.salesman_id = b.salesman_id WHERE grade < 300  
ORDER BY a.customer_id;

SELECT customer_name AS "Customer Name", city, salesman_name AS "Salesman", commission FROM customers a  
INNER JOIN salesman b ON a.salesman_id = b.salesman_id WHERE commission > 12;

SELECT order_no, order_date, purchase_amount, customer_name AS "Customer Name", grade, salesman_name AS "Salesman", commission FROM orders a  
...
SELECT customer_id, customer_name FROM customers a WHERE 1<(SELECT COUNT(*) FROM orders b WHERE a.customer_id = b.customer_id) 
UNION SELECT salesman_id, salesman_name FROM salesman a 
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE a.salesman_id = b.salesman_id) 
ORDER BY customer_name;
