...
public class Activity5 {
    ...
    public void sendText(){
        ...
        driver.findElement(AppiumBy.id("ContactSearchField")).sendKeys("7702891598");
        ...
        String status = driver.findElement(AppiumBy.xpath("//android.view.View[@resource-id=\"message_list\"]/android.view.View[1]/android.view.View[2]")).getText();
